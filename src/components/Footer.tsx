...
const Footer = () => {
  return (
    <>
      <div className="bg-footercolor pt-5 text-white">
      ...
      <div className="bg-gray-100 pt-2 text-white">
        <div
          className="flex pb-5 px-3 m-auto pt-5 border-t text-whitetext-sm flex-col
      max-w-screen-lg items-center"
        >
          <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
            <a href="/#" className="w-6 mx-1">
              <svg
                className="fill-current cursor-pointer text-gray-500 hover:text-footercolor"
                width="100%"
                height="100%"
                viewBox="0 0 24 24"
                version="1.1"
